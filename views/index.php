  ...
  <body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        <div class="logo">
          <a href="index.html"
            ><img src="../public/img/logo-1.png" alt="" class="img-fluid"
          /></a>
        </div>
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li class="dropdown">
                  <a href="#"
                    ><span>Custom</span> <i class="bi bi-chevron-right"></i
                  ></a>
                  <ul>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img">
            <img
              src="../public/img/studioeditedv3.svg"
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 footer-contact">
              <h3><img src="../public/img/logosmall.svg" alt="" /></h3>
              <p>
                2 Haroun El Rashid St. <br />
                El-Bostan, Heliopolis<br />
                Cairo <br />
                <strong>Phone:</strong> +2 012 2310 4558<br />
                <strong>Email:</strong> photo.wahba@gmail.com<br />
              </p>
            </div>
